================================================================================
    MFC 라이브러리 : balling 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 balling 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 balling 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
balling.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CballingApp 응용 프로그램
    클래스를 선언합니다.

balling.cpp
    응용 프로그램 클래스 CballingApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\balling.ico
    ...
    주 리소스 파일인 balling.rc에 의해 포함됩니다.
...
res\Toolbar.bmp
 ...
 리소스 편집기를 사용하여 이 도구 모음 비트맵을 편집하고
    balling.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 balling.pch와
